...
class SessionEndRequest(BaseModel):
    ...
    audio_mime_type: Optional[str] = None
    session_id: Optional[str] = Field(None, description="Streaming session ID for chunked summarization")
...
# ---------------------------------------------------------------------------
# Session Help (hotkey assistance)
# ---------------------------------------------------------------------------

class SessionHelpRequest(BaseModel):
    """Request for hotkey help during live interview."""
    session_id: str = Field(..., description="Session ID from streaming connection")
    context_lines: int = Field(4, ge=1, le=10, description="Number of recent lines for context")


class SessionHelpResponse(BaseModel):
    """Response with AI-generated answer help."""
    success: bool
    context: Optional[str] = Field(None, description="Transcript context that was used")
    answer: Optional[str] = Field(None, description="AI-generated answer help")
    reason: Optional[str] = Field(None, description="Explanation if no help generated")
...
class StreamSessionStartRequest(BaseModel):
    ...
    pass  # Session ID generated by backend


class StreamSessionStartResponse(BaseModel):
    """Response with session details for streaming."""
    session_id: str
    websocket_url: str
    allowed: bool
    reason: Optional[str] = None
